...
@Setter
@NoArgsConstructor
public class WAUser implements UserDetails {
    @Id
    ...
    @OneToOne(mappedBy = "waUser", cascade = CascadeType.ALL)
    ...
    public WAUser(String username, String password, String email, String role) {
